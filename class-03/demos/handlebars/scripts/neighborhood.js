...
// Identify the handlebars template.
...
Neighborhood.prototype.toHtml = function() {
  ...
  container.append(`<p>Part of: ${this.city}</p>`);
  container.append(`<p>Current population: ${this.population}</p>`);
  container.append(`<p>Founded On: ${this.founded}</p>`);
