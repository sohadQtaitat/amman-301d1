...
// it invoked indicate to aparticular object undefined value from inside the scope of the scope method

// 2. What is "this" when joe.scopeArrow() is invoked?
// closest parent window object and use the value of this in the scope we invoked

// 3. Explain why "this" is different when an arrow function is used?
// the arrow functions are unusable for object methods so they do not have their own " this ". The value of " this " inside an arrow function remains the same throughout the lifecycle of the function and is always bound to the value of " this " in the closest non-arrow parent function.
